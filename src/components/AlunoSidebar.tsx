...
const menuItems = [
  ...
  { name: 'Minhas Mensalidades', href: '/aluno/minhas-mensalidades', icon: Receipt },
];

export function AlunoSidebar({ onLogout, usuarioNome, usuarioId, notificacoesNaoLidas = 0 }: AlunoSidebarProps) {
  ...
  const whatsappLink = () => {
    ...
    return `https://wa.me/5511999999999?text=${mensagem}`; // Substitua pelo número real
  };
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg text-gray-900 dark:text-white">Área do Aluno</span>
        </div>
        <div className="flex items-center gap-2">
          {usuarioId && <NotificacoesDropdown usuarioId={usuarioId} />}
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="font-bold text-lg text-gray-900 dark:text-white">Área do Aluno</h1>
                <p className="text-xs text-gray-500">Acompanhe suas mensalidades</p>
              </div>
            </div>
          </div>
          ...
          <nav className="flex-1 p-4 space-y-1">
            ...
            <a
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-lg text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 transition-colors"
            >
